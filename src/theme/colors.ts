...
export const colors = {
  ...
  networkEthereumSoft: 'rgba(98, 126, 234, 0.15)',
  networkClassic: '#33FF99',
  networkClassicSoft: 'rgba(51, 255, 153, 0.15)',
  networkArbitrum: '#28A0F0',
  networkArbitrumSoft: 'rgba(40, 160, 240, 0.15)',
  networkAvalanche: '#E84142',
  networkAvalancheSoft: 'rgba(232, 65, 66, 0.15)',
  networkBase: '#0052FF',
  networkBaseSoft: 'rgba(0, 82, 255, 0.15)',
  networkBsc: '#F0B90B',
  networkBscSoft: 'rgba(240, 185, 11, 0.15)',
  networkCelo: '#FCFF52',
  networkCeloSoft: 'rgba(252, 255, 82, 0.15)',
  networkOptimism: '#FF0420',
  networkOptimismSoft: 'rgba(255, 4, 32, 0.15)',
  networkPolygon: '#A457FF',
  networkPolygonSoft: 'rgba(164, 87, 255, 0.15)',
...
const commonTheme = {
  ...
  brandedGradient: 'linear-gradient(139.57deg, #33FF99 5%, #B3FFD9 95%);',
