...
const CHAIN_INFO: ChainInfoMap = {
  [ChainId.MAINNET]: {
    ...
    backgroundColor: darkTheme.chain_1_background,
  },
  [ChainId.GOERLI]: {
    networkType: NetworkType.L1,
    docs: 'https://docs.uniswap.org/',
    ...
    backgroundColor: darkTheme.chain_5_background,
  },
  [ChainId.SEPOLIA]: {
    networkType: NetworkType.L1,
    docs: 'https://docs.uniswap.org/',
    ...
    color: darkTheme.chain_11155111,
    backgroundColor: darkTheme.chain_11155111_background,
  },
  [ChainId.CLASSIC]: {
    networkType: NetworkType.L1,
  ...
  [ChainId.CELO]: {
    ...
    color: darkTheme.chain_42220,
    backgroundColor: darkTheme.chain_42220_background,
  },
  [ChainId.CELO_ALFAJORES]: {
    ...
    nativeCurrency: { name: 'Celo', symbol: 'CELO', decimals: 18 },
    defaultListUrl: CELO_LIST,
    color: darkTheme.chain_44787,
    backgroundColor: darkTheme.chain_44787_background,
  },
  [ChainId.OPTIMISM]: {
    networkType: NetworkType.L2,
    blockWaitMsBeforeWarning: ms(`25m`),
  ...
  [ChainId.OPTIMISM_GOERLI]: {
    ...
    backgroundColor: darkTheme.chain_420_background,
  },
  [ChainId.POLYGON]: {
    networkType: NetworkType.L1,
    blockWaitMsBeforeWarning: ms(`10m`),
