...
export type ActivityDetailsInput = {
  readonly offRampTransactionDetails?: InputMaybe<OffRampTransactionDetailsInput>;
...
export type AssetChangeInput = {
  ...
  readonly offRampTransfer?: InputMaybe<OffRampTransferInput>;
...
export type OffRampServiceProvider = {
  readonly __typename?: 'OffRampServiceProvider';
  readonly id: Scalars['ID'];
...
export type OffRampTransactionDetails = {
  readonly __typename?: 'OffRampTransactionDetails';
  readonly id: Scalars['ID'];
  readonly offRampTransfer: OffRampTransfer;
  readonly senderAddress: Scalars['String'];
  readonly status: TransactionStatus;
};

export type OffRampTransactionDetailsInput = {
  readonly offRampTransfer: OffRampTransferInput;
  readonly senderAddress: Scalars['String'];
  readonly status: TransactionStatus;
};

export type OffRampTransfer = {
  readonly __typename?: 'OffRampTransfer';
  readonly amount: Scalars['Float'];
  readonly destinationAmount: Scalars['Float'];
  readonly destinationCurrency?: Maybe<Scalars['String']>;
  readonly externalSessionId: Scalars['String'];
  readonly id: Scalars['ID'];
  readonly networkFee?: Maybe<Scalars['Float']>;
  readonly serviceProvider: OffRampServiceProvider;
...
export type OffRampTransferInput = {
  readonly amount: Scalars['Float'];
  readonly destinationAmount: Scalars['Float'];
  readonly destinationCurrency?: InputMaybe<Scalars['String']>;
  readonly networkFee?: InputMaybe<Scalars['Float']>;
  readonly serviceProvider: OffRampServiceProviderInput;
...
export type RewardsCampaign = {
  readonly __typename?: 'RewardsCampaign';
  readonly boostedApr: Scalars['Float'];
  readonly distributedRewards?: Maybe<Scalars['String']>;
  readonly endTimestamp?: Maybe<Scalars['Int']>;
  readonly id: Scalars['ID'];
  readonly startTimestamp?: Maybe<Scalars['Int']>;
  readonly totalRewardAllocation?: Maybe<Scalars['String']>;
};
...
export type V4Pool = {
  ...
  readonly priceHistory?: Maybe<ReadonlyArray<Maybe<TimestampedPoolPrice>>>;
  readonly protocolVersion: ProtocolVersion;
  readonly rewardsCampaign?: Maybe<RewardsCampaign>;
